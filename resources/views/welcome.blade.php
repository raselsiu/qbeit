...
<body>
            ...
            <div class="th-mobile-menu allow-natural-scroll">
                <ul>
                    <li class="menu-item-has-children mega-menu-wrap"><a class="active" href="index.html">Home</a>
                        <ul class="sub-menu">
                            <li><a href="index.html">Home IT Solution</a></li>
    ...
    <div class="th-hero-wrapper hero-1" id="hero">
        <div class="swiper th-slider hero-slider-1" id="heroSlide1"
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="hero-inner">
                        <div class="th-hero-bg" data-bg-src="{{ asset('assets/img/hero/hero_bg_1_1.jpg') }}"></div>
                        <div class="hero-1-shape d-none d-lg-block" data-ani="slideinleft" data-ani-delay="0.4s"><img
                                src="{{ asset('frontend/assets/img/shape/hero-1-shape.png') }}" alt="hero-shape">
                        </div>
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-9 col-lg-8">
                                    <div class="hero-style1"><span class="sub-title style1" data-ani="slideinup"
                                            data-ani-delay="0.2s">Dynamic IT, Dynamic Results.</span>
                                        <h1 class="hero-title" data-ani="slideinup" data-ani-delay="0.4s">Precision
                                            IT
                                            Solutions, Tailored for You</h1>
                                        <p class="hero-text text-white" data-ani="slideinup" data-ani-delay="0.6s">
                                            Welcome to QBeIT where we specialize in delivering tailored technology and
                                            IT
                                            solutions.</p>
                                        <div class="btn-group" data-ani="slideinup" data-ani-delay="0.8s"><a
                                                href="contact.html" class="th-btn style7 th-icon">Discover More <i
                                                    class="fa-light fa-arrow-right-long"></i> </a><a
                                                href="service.html" class="th-btn style2 th-icon">Our Services <i
            ...
            <div class="th-swiper-custom"><button data-slider-prev="#heroSlide1"
                    class="slider-arrow slider-prev"><img
                ...
                <div class="row gx-0 justify-content-center">
                    <div class="col-xl-4 col-lg-6">
                        <div class="feature-item d-flex align-items-start">
                            <div class="feature-item_icon"><img
                                    src="{{ asset('frontend/assets/img/icon/feature_1_1.svg') }}" alt="icon">
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <div class="feature-item d-flex align-items-start">
                            <div class="feature-item_icon"><img
                                    src="{{ asset('frontend/assets/img/icon/feature_1_2.svg') }}" alt="icon">
                            </div>
                            <div class="media-body">
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <div class="feature-item d-flex align-items-start">
                            <div class="feature-item_icon"><img
                                    src="{{ asset('frontend/assets/img/icon/feature_1_3.svg') }}" alt="icon">
                            </div>
                            <div class="media-body">
            ...
            <div class="row gy-40">
                <div class="col-xl-6 col-lg-6">
                    <div class="title-area mb-20"><span class="sub-title style1 text-anime-style-2">Who We Are</span>
                        <h2 class="sec-title mb-20 text-anime-style-3">We Build Software That Builds Businesses.</h2>
                        <p class="sec-text mb-60 wow fadeInUp" data-wow-delay=".2s">A software development company
                            specializes in designing, developing, and deploying software applications tailored to meet
                            specific client needs. These companies combine technical expertise with innovative
                            strategies to deliver cutting-edge solutions for businesses across various industries. From
                            mobile apps to enterprise software, their services ensure that clients can achieve
                            operational efficiency, scalability.</p>
                    </div>
                    <div class="img-box8">
                        <div class="row gy-4">
                            <div class="col-xl-6 col-md-6 col-sm-6">
                                <div class="img1 reveal mb-0"><img
                                        src="{{ asset('frontend/assets/img/normal/about_7_1.jpg') }}" alt="About">
                                </div>
                            </div>
                            <div class="col-xl-6 col-md-6 col-sm-6">
                                <div class="img2 reveal mb-0"><img
                                        src="{{ asset('frontend/assets/img/normal/about_7_2.jpg') }}" alt="About">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="img-box8 ms-xl-5">
                        <div class="img3 reveal"><img src="{{ asset('frontend/assets/img/normal/about_7_3.jpg') }}"
                                alt="About"></div>
                        <div class="about-item-wrap">
                            <div class="about-item wow fadeInUp" data-wow-delay=".3s">
                                ...
                                <div class="about-item_centent">
                                    ...
                                    <p class="about-item_text">Access to a team of skilled developers, designers, and
                                        project managers.</p>
                                </div>
                            </div>
                            <div class="about-item wow fadeInUp" data-wow-delay=".4s">
                                ...
                                <div class="about-item_centent">
                                    ...
                                    <p class="about-item_text">Development tailored to specific business needs,
                                        ensuring
                                        better alignment with goals.</p>
                                </div>
                            </div>
                        </div>
                        <div class="mt-35 wow fadeInUp" data-wow-delay=".5s"><a href="about.html"
                                class="th-btn black-btn th-radius th-icon">Learn More <i
                                    class="fa-light fa-arrow-right-long"></i></a></div>
                    </div>
                </div>
            </div>
                ...
                <div class="swiper th-slider has-shadow"
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="service-box service-style-1 gsap-cursor">
                                <div class="service-img"><a href="service-details.html"><img
                                            src="{{ asset('frontend/assets/img/service/service_img_1.jpg') }}"
                                            alt=""></a></div>
                                <div class="service-content">
                                    <h3 class="box-title"><a href="service-details.html">IT Strategy & Planning</a>
                                    </h3>
                                    <p class="service-box_text">Assessing current IT infrastructure and aligning it
                                        with
                                        business goals. Developing a roadmap.</p><a class="th-btn style4"
                        ...
                        <div class="swiper-slide">
                            <div class="service-box service-style-1 gsap-cursor">
                                <div class="service-img"><a href="service-details.html"><img
                                            src="{{ asset('frontend/assets/img/service/service_img_2.jpg') }}"
                                            alt=""></a></div>
                                <div class="service-content">
                        ...
                        <div class="swiper-slide">
                            <div class="service-box service-style-1 gsap-cursor">
                                <div class="service-img"><a href="service-details.html"><img
                                            src="{{ asset('frontend/assets/img/service/service_img_3.jpg') }}"
                                            alt=""></a></div>
                                <div class="service-content">
                                    <h3 class="box-title"><a href="service-details.html">Cloud Consulting</a></h3>
                                    <p class="service-box_text">Assessing current IT infrastructure and aligning it
                                        with
                                        business goals. Developing a roadmap.</p><a class="th-btn style4"
                                        href="service-details.html">Read More <i
                        ...
                        <div class="swiper-slide">
                            <div class="service-box service-style-1 gsap-cursor">
                                <div class="service-img"><a href="service-details.html"><img
                                            src="{{ asset('frontend/assets/img/service/service_img_4.jpg') }}"
                                            alt=""></a></div>
                                <div class="service-content">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="th-team team-box">
                                <div class="team-img"><img src="{{ asset('frontend/assets/img/team/team_1_1.jpg') }}"
                                        alt="Team"></div>
                                <div class="team-content">
                                    <div class="media-body">
                                        ...
                                        <div class="th-social"><a target="_blank" href="https://facebook.com/"><i
                                                ...
                                                href="https://youtube.com/"><i class="fa-brands fa-youtube"></i></a>
                        ...
                        <div class="swiper-slide">
                            <div class="th-team team-box">
                                <div class="team-img"><img src="{{ asset('frontend/assets/img/team/team_1_2.jpg') }}"
                                        alt="Team"></div>
                                <div class="team-content">
                                    <div class="media-body">
                        ...
                        <div class="swiper-slide">
                            <div class="th-team team-box">
                                <div class="team-img"><img src="{{ asset('frontend/assets/img/team/team_1_3.jpg') }}"
                                        alt="Team"></div>
                                <div class="team-content">
                                    <div class="media-body">
                        ...
                        <div class="swiper-slide">
                            <div class="th-team team-box">
                                <div class="team-img"><img src="{{ asset('frontend/assets/img/team/team_1_4.jpg') }}"
                                        alt="Team"></div>
                                <div class="team-content">
                                    <div class="media-body">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="testi-card style2">
                                <div class="testi-card_wrapper">
                                    <div class="testi-card_profile" data-mask-src="assets/img/shape/testi-shape.png">
                                        <div class="testi-card_avater"><img src="assets/img/testimonial/testi_1_1.jpg"
                                                alt="testimonial"></div>
                                        <div class="media-body">
                                            <h3 class="box-title">Maria Doe</h3><span class="testi-card_desig">UI/UX
                                                Designer</span>
                                        </div>
                                    </div>
                                ...
                                <p class="testi-card_text">“Tech support services provide assistance to individuals and
                                    organizations in resolving technical issues related to hardware, software, networks,
                                    and other IT systems. These services are crucial for ensuring smooth operations,”
                                </p>
                                    ...
                                    <div class="testi-card_profile" data-mask-src="assets/img/shape/testi-shape.png">
                                        ...
                                        <div class="media-body">
                                            <h3 class="box-title">Andrew Simon</h3><span
                                                class="testi-card_desig">Front-End Dev</span>
                                        </div>
                                    </div>
                                    <div class="testi-card_review"><i class="fa-solid fa-star"></i> <i
                                            class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i
                                    ...
                                    <div class="testi-card_profile" data-mask-src="assets/img/shape/testi-shape.png">
                                        ...
                                        <div class="media-body">
                                            <h3 class="box-title">Alex Jordan</h3><span
                                                class="testi-card_desig">Software Eng</span>
                                        </div>
                                    </div>
                                    <div class="testi-card_review"><i class="fa-solid fa-star"></i> <i
                                            class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i
                                ...
                                <div class="testi-card_wrapper">
                                    <div class="testi-card_profile" data-mask-src="assets/img/shape/testi-shape.png">
                                        <div class="testi-card_avater"><img src="assets/img/testimonial/testi_1_2.jpg"
                                                alt="testimonial"></div>
                                        <div class="media-body">
                                            <h3 class="box-title">Maria Doe</h3><span class="testi-card_desig">Python
                                                Deve</span>
                                        </div>
                                    </div>
                                    <div class="testi-card_review"><i class="fa-solid fa-star"></i> <i
                                    ...
                                    <div class="testi-card_profile" data-mask-src="assets/img/shape/testi-shape.png">
                                        ...
                                        <div class="media-body">
                                            <h3 class="box-title">Angelina Rose</h3><span
                                                class="testi-card_desig">WordPress Dev</span>
                                        </div>
                                    </div>
                                    <div class="testi-card_review"><i class="fa-solid fa-star"></i> <i
                                            class="fa-solid fa-star"></i> <i class="fa-solid fa-star"></i> <i
                                    ...
                                    <div class="testi-card_profile" data-mask-src="assets/img/shape/testi-shape.png">
                                        ...
                                        <div class="media-body">
                                            <h3 class="box-title">Maria Doe</h3><span
                                                class="testi-card_desig">Graphics
                                                Designer</span>
                                        </div>
                                    </div>
                                    <div class="testi-card_review"><i class="fa-solid fa-star"></i> <i
                                ...
                                <div class="testi-card_wrapper">
                                    <div class="testi-card_profile" data-mask-src="assets/img/shape/testi-shape.png">
                                        <div class="testi-card_avater"><img src="assets/img/testimonial/testi_1_1.jpg"
                                                alt="testimonial"></div>
                                        <div class="media-body">
                                            <h3 class="box-title">Alex Jordan</h3><span class="testi-card_desig">CEO
                                                QBeIT</span>
                                        </div>
                                    </div>
                                    <div class="testi-card_review"><i class="fa-solid fa-star"></i> <i
            ...
            <div class="row gy-4 align-items-center">
                <div class="col-lg-6 order-1 order-lg-0">
                    <div class="title-area"><span class="sub-title style1 text-anime-style-2">Why Choose Us</span>
                        <h2 class="sec-title text-anime-style-2">Building the Future of Technology Today</h2>
                        <p class="sec-text me-xl-5 wow fadeInUp" data-wow-delay=".3s">A software development company
                            specializes in designing, developing, and deploying software applications tailored to meet
                            specific client needs. These companies combine technical expertise with innovative
                    ...
                    <div class="choose-about wow fadeInUp">
                        ...
                        <div class="media-body">
                            ...
                            <p class="choose-about_text pe-xl-5 me-xl-5">Staying updated with the latest trends through
                                continuous learning and innovation.</p>
                        </div>
                    </div>
                    <div class="choose-about wow fadeInUp">
                        <div class="choose-about_icon"><img
                        ...
                        <div class="media-body">
                            ...
                            <p class="choose-about_text pe-xl-5 me-xl-5">Adhering to industry standards like GDPR,
                                HIPAA, and ISO for data protection.</p>
                        </div>
                    </div>
                    <div class="choose-about wow fadeInUp">
                        <div class="choose-about_icon"><img
                        ...
                        <div class="media-body">
                            ...
                            <p class="choose-about_text pe-xl-5 me-xl-5">Rigorous testing processes to deliver bug-free
                                and high-performing software.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row gy-50 justify-content-center align-items-center">
                    <div class="col-lg-8 order-lg-2">
                        <div class="title-area text-center mb-30"><span class="sub-title text-white"><span
                            ...
                            <h2 class="sec-title text-white"><span class="scroll-text-ani2">We Make Awesome IT
                                    Services
                                    For Your Newly Business</span></h2>
                        </div>
                        <div class="btn-wrap justify-content-center"><a href="project.html"
                                class="th-btn style3 th-radius th-icon">Start A Projects <i
                                    class="fa-light fa-arrow-right-long"></i></a>
                            <div class="call-btn style2">
                                <div class="icon-btn text-white"><i class="far fa-phone"></i></div>
                                <div class="btn-content">
                                    <h6 class="btn-title"><a class="text-white" href="tel:0123456789">Call Us:
                                            +253-3258
                                            235</a></h6><span class="btn-text text-gray2">For any question</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="overflow-hidden space bg-smoke overflow-hidden" id="blog-sec">
        <div class="container">
            <div class="mb-30 text-center text-md-start">
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-md-auto wow fadeInUp"><a href="blog.html" class="th-btn style4 th-icon">See More
                            Articles <i class="fa-light fa-arrow-right-long"></i></a></div>
                </div>
            </div>
            <div class="slider-area">
        ...
        <div class="shape-mockup shape1 d-none d-xxl-block" data-bottom="5%" data-left="3%"><img
                src="assets/img/shape/blog-1-shape.png" alt="shape"></div>
        <div class="shape-mockup shape2 d-none d-xl-block" data-top="28%" data-right="5%"><img
                        ...
                        <div class="widget footer-widget">
                            <div class="th-widget-about">
                                <div class="about-logo">
                                    <!-- <a href="index.html"><img src="" alt="QBeIT"></a> -->
                                    <h3 style="color: white;">Logo</h3>
                                </div>
                                <p class="about-text">Titan Court
                                    2nd Floor,
                                    3 Bishop Square,
                                    Hatfield, Hertfordshire, United Kingdom, AL10 9NA</p>
                        ...
                        <div class="widget footer-widget">
                            ...
                            <div class="th-widget-contact">
                                ...
                                <div class="info-box_text">
                                    ...
                                    <div class="details">
                                        <p><a href="mailto:mailinfo00@QBeIT.com"
                                                class="info-box_link">mailinfo00@QBeIT.com</a></p>
                                        <p><a href="mailto:support24@QBeIT.com"
                                                class="info-box_link">support24@QBeIT.com</a></p>
                                    </div>
                                </div>
                                <div class="info-box_text">
        ...
        <div class="copyright-wrap">
            <div class="container">
                <div class="row justify-content-lg-between align-items-center">
                    <div class="col-lg-6">
                        <p class="copyright-text">Copyright © 2025 <a href="index.html">QBeIT</a>. All Rights
                            Reserved.
                        </p>
                    </div>
