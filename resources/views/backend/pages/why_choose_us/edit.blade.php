        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form action="{{ route('whyChooseUsUpdate', $why->id) }}" method="POST"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control" id="title"
                                            placeholder="Write section Title" value="{{ $why->title }}" required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="desc" class="form-control" id="editor1" cols="5" rows="3"
                                            placeholder="Write section description..">{{ $why->desc }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <hr>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="feature_1_title" class="form-control"
                                            id="feature_image_right" placeholder="Write Feature One Title"
                                            value="{{ $why->feature_1_title }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="feature_1_desc" class="form-control"
                                            id="feature_image_one" placeholder="Enter short description"
                                            value="{{ $why->feature_1_desc }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="feature_2_title" class="form-control"
                                            id="feature_2_title" placeholder="Enter Feature Title"
                                            value="{{ $why->feature_2_title }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="feature_2_desc" class="form-control" id="feature_2_desc"
                                            placeholder="Enter short Description" value="{{ $why->feature_2_desc }}"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="feature_3_title" class="form-control"
                                            id="feature_3_title" placeholder="Enter Feature Title"
                                            value="{{ $why->feature_3_title }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="feature_3_desc" class="form-control"
                                            id="feature_3_desc" placeholder="Enter short Description"
                                            value="{{ $why->feature_3_desc }}" required>
                                    </div>
                                </div>
