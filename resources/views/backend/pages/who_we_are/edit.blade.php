            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Update Section - Who We Are</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('whoWeAreUpdate', $who->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control" id="title"
                                            value="{{ $who->title }}" placeholder="Enter Your Title" required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control" id="description" cols="5" rows="3"
                                            placeholder="Write section description..">{{ $who->description }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="feature_image_right" class="form-control"
                                            id="feature_image_right" placeholder="Upload an Image">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="feature_image_one" class="form-control"
                                            id="feature_image_one" placeholder="Upload feature image">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="feature_image_two" class="form-control"
                                            id="feature_image_two" placeholder="Upload Feature Image">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="feature_one_desc" class="form-control"
                                            id="feature_one_desc" placeholder="Write short subtitle"
                                            value="{{ $who->feature_one_desc }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="feature_two_title" class="form-control"
                                            id="feature_two_title" placeholder="Write short title"
                                            value="{{ $who->feature_two_title }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="feature_two_desc" class="form-control"
                                            id="feature_two_desc" placeholder="Write short subtitle"
                                            value="{{ $who->feature_two_desc }}" required>
                                    </div>
                                </div>
